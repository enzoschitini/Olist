...
def maps(olist):
    ...
    with col2:
        opcao = mtc.escolher_opcao('Escolha como você deseja analisar os dados', ['Visão geral das regiões e estados', 
                                                                                  'Vendedores e pontos de venda', 
    ...
    if opcao == 'Visão geral das regiões e estados':
        @st.cache_data
    ...
    if opcao == 'Vendedores e pontos de venda':
        col1, col2 = st.columns([1, 3])
        with col1:
            pass
        with col2:
    ...
    if opcao == 'Comparação das regiões':
